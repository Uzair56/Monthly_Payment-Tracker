                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="{{url('edit-payment/'.$user->id)}}" class="btn btn-info btn-sm" title="Edit"><i class="pe-7s-pen"></i></a>
                                                <a href="javascript:;" class="btn btn-success btn-sm clear" data-id="{{encrypt($user->id)}}" title="Payment Clear"><i class="pe-7s-refresh-2"></i></a>
                                                <a href="javascript:;" class="btn btn-danger btn-sm delete" data-id="{{encrypt($user->id)}}" title="Delete"><i class="pe-7s-trash"></i></a>
